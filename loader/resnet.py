...
from loader.activations_autofn import MishAuto, SwishAuto
...
def ResidualNet(network_type, depth, num_classes):
    ...
    if depth == 18:
        model = ResNetMish(BasicBlock, [2, 2, 2, 2], network_type, num_classes)

    if depth == 50:
        model = ResNetMish(Bottleneck, [3, 4, 6, 3], network_type, num_classes)
    # elif depth == 34:
